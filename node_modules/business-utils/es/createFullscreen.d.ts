 ...
 * ```
 */
export default function createFullscreen(elementContext: ElementContext, documentContext: DocumentContext, changeCallback?: () => void): {
    events: string[];
    readonly isDomFullscreenSupported: boolean;
    requestFullscreen(): void;
    exitFullscreen(): void;
    readonly fullscreenElement: Element | null | undefined;
    remove(): void;
};
export {};
